...
exports.default = function (options, currentTextNode, matched, change) {
  ...
  var addText = matched[0].trim().replace(new RegExp(reg, "g"), "");
  ...
  })).insertTextByKey(currentTextNode.key, matched.index, addText, [_slate.Mark.create({ type: options.BOLD }), _slate.Mark.create({ type: options.ITALIC })]).call(_trailingSpace2.default, currentTextNode, matched.index).call(_slateHelperMarkRemoveall2.default);
};
